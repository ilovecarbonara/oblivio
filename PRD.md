...
- Animated card flip (stretch goal only — static swap is acceptable).
...
| Week 4 | Pixel art assets integrated, audio integrated, polish and bug fixing |
